...
class ChessBoard(object):
    ...
    def create_chess(self):
        ...
        #     ["", "r_p", "", "", "", "", "", "r_p", ""],
        #     ["", "", "", "", "", "", "", "", ""],
        #     ["", "r_m", "r_x", "r_s", "r_j", "r_s", "r_x", "r_m", ""],
        # ]



# 旧位置： 6 2 新位置： 9 2 8步双方没有互吃棋子
    ...
    def judge_delete_position(self, all_position, clicked_chess):
        ...
        return all_position
    def my_move(self,chess,new_row, new_col):
        old_row, old_col = chess.row,chess.col
        # 移动位置
        self.chessboard_map[new_row][new_col] = chess#self.chessboard_map[old_row][old_col]
        # 修改棋子的属性
